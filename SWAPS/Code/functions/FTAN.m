function [ENVEL_p,ENVEL_n,ffilt,vel] = FTAN(ffilt,lag,ccf,fs,d,sdi,sdf)
...
ENVEL_p = ENVEL(:,zp+1:end);
ENVEL_n = fliplr(ENVEL(:,1:zp-1));

vel = d./t;


assignin('base','ENVEL_p',ENVEL_p)
assignin('base','ENVEL_n',ENVEL_n)
